...
class ACL
{
	...
	public static $role_pages = array(
			'program_manager' =>
						array(
							'stock_movements' => array('view','add','edit', 'editfield','delete','import_data'),
			...
			'admin' =>
						array(
							'batches' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'categories' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'items' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'locations' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'program_managers' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'stock_movements' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'suppliers' => array('list','view','add','edit', 'editfield','delete','import_data'),
