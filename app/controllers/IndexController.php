...
class IndexController extends BaseController{
    ...
    render_error("Your account is pending admin approval.");
    unset($_SESSION[ID_SESSION]); // Log them out immediately
    redirect_to("login");
}
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("username","password","role","email","is_active","first_name","middle_name","last_name","position","program_name","account_status","photo","encodedby_id","fullname"); //registration fields
