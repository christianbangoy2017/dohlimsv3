...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Stock Movements</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-stock_movements_reasons_reason_code">
                                        <th class="title"> Reason Code: </th>
                                        <td class="value"> <?php echo $data['stock_movements_reasons_reason_code']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-locations_location_name">
                                        <th class="title"> Location: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['locations_location_name']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                ...
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['locations_location_name']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-users_program_name">
                                        <th class="title"> Program Name: </th>
                                        <td class="value"> <?php echo $data['users_program_name']; ?></td>
                                    </tr>
                                    <tr  class="td-users_fullname">
                                        <th class="title"> Program Manager: </th>
                                        <td class="value"> <?php echo $data['users_fullname']; ?></td>
                                    </tr>
                                    <tr  class="td-reference_no">
                                        <th class="title"> Reference No: </th>
                                        <td class="value">
