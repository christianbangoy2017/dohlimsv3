...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Stock Movements</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("stock_movements/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-reference_no"  value="<?php  echo $data['reference_no']; ?>" type="text" placeholder="Enter Reference No"  required="" name="reference_no"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <input id="ctrl-encodedby_id"  value="<?php  echo $data['encodedby_id']; ?>" type="hidden" placeholder="Enter Encodedby Id" list="encodedby_id_list"  required="" name="encodedby_id"  class="form-control " />
