                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    ...
                                                    $field_value = $data['movement_type'];
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-reference_no"  value="<?php  echo $data['reference_no']; ?>" type="text" placeholder="Enter Reference No"  name="reference_no"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
