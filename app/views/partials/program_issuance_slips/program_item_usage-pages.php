    ...
    $can_list = ACL::is_allowed("program_item_usage/list/issuance_id/$field_value");$can_view = ACL::is_allowed("program_item_usage/view/$field_value");$can_add = ACL::is_allowed("program_item_usage/add/?issuance_id=$field_value");
    ...
    <div class="master-detail-page">
        <div class="card-header p-0 pt-2 px-2">
            <ul class="nav nav-tabs">
                ...
                <?php if($can_view){ ?>
                <li class="nav-item">
                    <a data-toggle="tab" href="#program_issuance_slips_program_item_usage_View_<?php echo $page_id ?>" class="nav-link ">
                        View
                    </a>
                </li>
                <?php } ?>
        ...
        <div class="tab-content">
            ...
            <?php } ?>
            <?php if($can_view){ ?>
            <div class="tab-pane fade show " id="program_issuance_slips_program_item_usage_View_<?php echo $page_id ?>" role="tabpanel">
