                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-generic_name"> Generic Name</th>
                                                <th  class="td-category_id"> Category Id</th>
                                                <th  class="td-unit_of_measure"> Unit Of Measure</th>
                                                <th  class="td-min_stock_level"> Min Stock Level</th>
                                                <th  class="td-is_active"> Is Active</th>
                                                <th  class="td-itemname_generic"> Itemname Generic</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
