                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-supplier_type"  value="<?php  echo $data['supplier_type']; ?>" type="text" placeholder="Enter Supplier Type"  required="" name="supplier_type"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
