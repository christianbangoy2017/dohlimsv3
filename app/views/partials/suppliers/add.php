                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="supplier_type">Supplier Type <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-supplier_type"  value="<?php  echo $this->set_field_value('supplier_type',"PHARMACEUTICAL"); ?>" type="text" placeholder="Enter Supplier Type"  required="" name="supplier_type"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
