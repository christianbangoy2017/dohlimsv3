...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Program Item Usage</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("program_item_usage/add") ?>">
                        <i class="material-icons">add</i>                               
                        Add New Program Item Usage 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('program_item_usage'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('program_item_usage'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="program_item_usage-list-records">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-program_issuance_slips_slip_no">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/program_item_usage_program_issuance_slips_slip_no_option_list'); ?>' 
                                                            data-value="<?php echo $data['program_issuance_slips_slip_no']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['program_issuance_slips_slip_no']; ?> 
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="td-program_issuance_slips_purpose">
                                                        <span <?php if($can_edit){ ?> data-pk="<?php echo $data['id'] ?>" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['program_issuance_slips_purpose']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-batches_expiry_date">
                                                        <span <?php if($can_edit){ ?> data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                            data-value="<?php echo $data['batches_expiry_date']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                    ...
                                                    <td class="page-list-action td-btn">
                                                        <div class="dropdown" >
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <?php if($can_view){ ?>
                                                                <a class="dropdown-item" href="<?php print_link("program_item_usage/view/$rec_id"); ?>">
                                                                    <i class="material-icons">visibility</i> View 
                                                                </a>
                                                                <?php } ?>
                                                                <?php if($can_edit){ ?>
                                                                <a class="dropdown-item" href="<?php print_link("program_item_usage/edit/$rec_id"); ?>">
                                                                    <i class="material-icons">edit</i> Edit
                                                                </a>
                                                                <?php } ?>
                                                                <?php if($can_delete){ ?>
                                                                <a  class="dropdown-item record-delete-btn" href="<?php print_link("program_item_usage/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <?php if($can_delete){ ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("program_item_usage/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
