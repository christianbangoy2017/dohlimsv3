...
$can_add = ACL::is_allowed("clients/add");
$can_edit = ACL::is_allowed("clients/edit");
$can_view = ACL::is_allowed("clients/view");
$can_delete = ACL::is_allowed("clients/delete");
?>
<?php
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-contactnumber">
                                        <th class="title"> Contactnumber: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['contactnumber']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("clients/editfield/" . urlencode($data['id'])); ?>" 
                                    ...
                                    <tr  class="td-isactive">
                                        <th class="title"> Isactive: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php echo json_encode_quote(Menu :: $isactive); ?>' 
                                                data-value="<?php echo $data['isactive']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("clients/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="isactive" 
